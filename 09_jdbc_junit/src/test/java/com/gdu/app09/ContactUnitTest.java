 ...
 *     1) <bean> 태그 : @ContextConfiguration(locations="src/main/webapp/WEB-INF/spring/appServlet/root-context.xml")
...
@ContextConfiguration(locations="src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml")
...
public class ContactUnitTest {
  ...
  @Autowired   // Spring Container에서 ContacctDao 객체(Bean)를 가져온다.
