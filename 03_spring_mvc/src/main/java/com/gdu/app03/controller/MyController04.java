...
/************************** 세션에 저장하기 ***************************/  
  ...
  public String add3(HttpServletRequest request, Model model) {
    model.addAttribute("title", request.getParameter("title")); //request 파라미터를 저장
    return "article/result";
   }
...
/****************************** 세션 정보 삭제하기 ******************************/
   ...
   */
  @GetMapping("/article/confirm.do")
  public String confirm2(@SessionAttribute("title") String title) {  // session에 저장된 title 속성을 string title에 저장하세요
    System.out.println(title);
    return "index";
  }
